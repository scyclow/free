...
/*
  ...
  if they do not double or nothing after 2000000 blocks, anyone with a free18 token can withdraw the token and the eth
*/
...
contract Free18 {
  ...
  function withdraw(uint256 stakedFree0TokenId, uint256 free18TokenId) public {
    ...
    require(free.tokenIdToCollectionId(free18TokenId) == 18, 'Invalid Free18');
    require(free.ownerOf(free18TokenId) == msg.sender, 'You must be the owner of this Free18');
